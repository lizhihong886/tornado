...
import io
import check_code
from session.session import CacheSession
from form.forms import BaseForm
from form.fields import StringField
from form.fields import IntegerField
from form.fields import EmailField
...
class RegisterForm(BaseForm):  #需要继承上面的form验证基类
